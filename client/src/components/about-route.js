...
class AboutRoute extends Component {
  render() {
    return (
      <div className="route route__about">
        <p className="make-me-taller-daddy squish-my-burrito">
        ...
        <div className="give-it-a-bit-more"></div>
        So anyway.. If you're looking for the next big nothing, a community run by a
        complete introvert, somewhere safe from SF politics, or you just need to vent out at a
        theatre screen &mdash; you're already home.
        <div className="give-it-a-bit-more"></div>
        (And I've seen enough Avengers for a lifetime too)
        </p>
      </div>
    );
  }
